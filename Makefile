...
XPKGS = provider-vkcloud
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-vkcloud: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider VkCloud CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider VkCloud controllers
...
# This target prepares repo for your provider by replacing all "vkcloud"
